  ...
  if (!article) {
    return (
      <div  className ="min-h-screen pt-32 flex flex-col items-center justify-center bg-[#f8fcfd]">
        ...
        < Link   href ="/tin-tuc"  className ="bg-[#FDB714] text-[#003046] font-black px-10 py-4 rounded-full hover:shadow-[0_15px_30px_rgba(253,183,20,0.4)] hover:-translate-y-1 transition-all uppercase tracking-[0.15em] text-xs">
    ...
    <main  className ="min-h-screen bg-[#f8fcfd] pb-24 overflow-x-hidden relative">
      ...
      <section  className ="relative pt-32 pb-40 bg-[#003046] overflow-hidden flex flex-col items-center justify-center min-h-[70vh]">
        ...
        < FadeIn   className ="max-w-4xl w-full mx-auto px-5 relative z-10 text-center text-white mt-10">
          < Link   href ="/tin-tuc"  className ="inline-flex items-center gap-2 text-white/60 hover:text-white text-[10px] font-bold mb-10 transition-colors uppercase tracking-[0.2em]">
            ← Trở về danh sách
          </ Link >
          <br/>
          ...
          <div  className ="flex flex-wrap items-center justify-center gap-6 text-xs font-bold text-white/80 uppercase tracking-widest">
            <span  className ="flex items-center gap-3">
              <span  className ="w-8 h-8 rounded-[0.8rem] bg-white/10 backdrop-blur-md text-[#60CBED] border border-white/20 flex items-center justify-center font-black text-[10px] shadow-inner">AD</span>
              {article.author}
            </span>
      ...
      <section  className ="max-w-4xl mx-auto px-5 -mt-32 relative z-20">
        < FadeIn   className ="bg-white rounded-[3rem] shadow-[0_30px_80px_rgba(0,48,70,0.08)] p-8 md:p-14 lg:p-20 border border-[#60CBED]/20">
          ...
          <div  className ="text-[#1a2e38] leading-relaxed font-medium">
            ...
            {/* 💡 TUYỆT CHIÊU: Đã ép whitespace-normal và break-words để ngăn tràn chữ */}
            <div
          ...
          <div  className ="mt-20 pt-10 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div  className ="flex flex-wrap justify-center gap-3">
              {['Facebook', 'Twitter', 'Copy Link'].map(( social ,  i ) => (
                <button  key ={ i }  className ="px-6 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs font-bold text-[#5a7a8a] hover:bg-[#60CBED] hover:text-[#003046] hover:border-[#60CBED] hover:shadow-[0_8px_20px_rgba(96,203,237,0.3)] hover:-translate-y-1 transition-all">
                  { social }
                </button>
              ))}
            </div>
      ...
      {relatedNews.length > 0 && (
        <section  className ="max-w-7xl mx-auto px-5 mt-32">
          < FadeIn   className ="flex flex-col md:flex-row items-center justify-between mb-12 gap-6 text-center md:text-left">
            ...
            < Link   href ="/tin-tuc"  className ="hidden md:inline-flex items-center gap-2 text-xs font-bold text-[#003046] hover:text-white hover:bg-[#003046] transition-all bg-white px-6 py-3.5 rounded-full shadow-[0_5px_15px_rgba(0,48,70,0.05)] border border-gray-200 uppercase tracking-widest">
              Xem tất cả →
            </ Link >
          </ FadeIn >
          ...
          <div  className ="grid grid-cols-1 md:grid-cols-3 gap-8">
            {relatedNews.map(( item ,  index ) => (
              < FadeIn   key ={ item ._id}  delay ={ index  * 150}  className ="bg-white rounded-[2.5rem] p-4 border border-[#60CBED]/10 shadow-[0_10px_30px_rgba(0,48,70,0.03)] hover:shadow-[0_20px_50px_rgba(96,203,237,0.15)] hover:-translate-y-2 transition-all duration-500 group flex flex-col relative overflow-hidden">
                ...
                <div  className ="pt-8 px-4 pb-4 flex flex-col flex-1 z-10">
                  ...
                  < Link   href ={`/tin-tuc/${ item ._id}`}  className ="mt-auto inline-flex items-center w-max font-black text-[#003046] text-[10px] uppercase tracking-[0.2em] group-hover:text-[#60CBED] transition-colors cursor-pointer bg-gray-50 hover:bg-[#f0faff] px-6 py-3.5 rounded-2xl border border-transparent hover:border-[#60CBED]/20">
          ...
          <div  className ="mt-12 text-center md:hidden">
            < Link   href ="/tin-tuc"  className ="inline-flex items-center gap-2 text-xs font-bold text-[#003046] hover:text-white hover:bg-[#003046] transition-all bg-white px-8 py-4 rounded-full shadow-md border border-gray-200 uppercase tracking-widest">
              Xem tất cả tin tức →
            </ Link >
          </div>
        </section>
