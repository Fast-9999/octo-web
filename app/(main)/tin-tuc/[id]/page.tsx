...
const FadeIn = ({ children, delay = 0, className = "" }: { children: React.ReactNode, delay?: number, className?: string }) => {
  ...
  useEffect(() => {
    ...
    // FIX SỐ 1: Hạ threshold xuống 0 và thêm rootMargin để nhạy hơn trên mobile
  ...
  return (
    <main className="min-h-screen bg-[#f8fcfd] pb-24 overflow-x-hidden relative">
      ...
      <section className="relative pt-32 pb-40 bg-[#003046] overflow-hidden flex flex-col items-center justify-center min-h-[70vh]">
        {/* FIX SỐ 2: Thêm hidden md:block để ẩn khối sáng nặng trên mobile */}
        <div className="hidden md:block absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-[#60CBED] rounded-full mix-blend-multiply filter blur-[150px] opacity-40 animate-pulse pointer-events-none"></div>
