...
const data = {
  ...
  return (
    <main className="min-h-screen bg-[#f8fcfd] pt-32 pb-24 relative overflow-x-hidden">
      ...
      {/* 💡 Ánh sáng nền Glow ảo diệu (Đã fix lỗi kích thước) */}
      ...
      <div className="max-w-7xl mx-auto px-5 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-28">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <FadeIn delay={100} className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-[#60CBED]/10 hover:border-[#60CBED]/40 hover:shadow-[0_20px_50px_rgba(96,203,237,0.15)] hover:-translate-y-2 transition-all duration-500 flex flex-col justify-center group shadow-sm">
            ...
            <FadeIn delay={200} className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-[#60CBED]/10 hover:border-[#60CBED]/40 hover:shadow-[0_20px_50px_rgba(96,203,237,0.15)] hover:-translate-y-2 transition-all duration-500 flex flex-col justify-center group shadow-sm">
              ...
              <a href="tel:0909964296" className="text-[#003046] text-xl font-black hover:text-[#60CBED] transition-colors">0909 964 296.</a>
              <p className="text-[#5a7a8a] text-[10px] uppercase tracking-[0.1em] mt-3 font-bold">Hỗ trợ 24/7.</p>
            </FadeIn>

            <FadeIn delay={300} className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-[#60CBED]/10 hover:border-[#60CBED]/40 hover:shadow-[0_20px_50px_rgba(96,203,237,0.15)] hover:-translate-y-2 transition-all duration-500 flex flex-col justify-center group shadow-sm">
              ...
              <a href="mailto:services@octo.vn" className="text-[#003046] text-lg font-black hover:text-[#60CBED] transition-colors">services@octo.vn.</a>
              <p className="text-[#5a7a8a] text-[10px] uppercase tracking-[0.1em] mt-3 font-bold">Phản hồi trong 24h.</p>
            </FadeIn>

            {/* 💡 Đã fix bg-gradient-to-br */}
            <FadeIn delay={400} className="bg-gradient-to-br from-[#f0faff] to-white rounded-[2.5rem] p-8 md:p-10 border border-[#60CBED]/30 hover:border-[#60CBED] hover:shadow-[0_20px_50px_rgba(96,203,237,0.15)] hover:-translate-y-2 transition-all duration-500 flex flex-col justify-center group">
          ...
          {/* Cột phải: Bản đồ Google Maps (Đã fix grayscale-[20%] và kích thước) */}
          <FadeIn delay={200} className="bg-white rounded-[3rem] overflow-hidden border-4 border-white shadow-[0_20px_50px_rgba(0,48,70,0.08)] hover:shadow-[0_30px_60px_rgba(0,48,70,0.15)] hover:border-[#60CBED]/20 transition-all duration-500 relative min-h-[350px] lg:min-h-full group">
        ...
        {/* 💡 Đã fix: bg-gradient-to-br và hiệu ứng Glow 2 màu */}
        <section className="relative bg-gradient-to-br from-[#003046] to-[#005070] rounded-[3.5rem] p-8 md:p-16 lg:p-24 overflow-hidden shadow-[0_30px_60px_rgba(0,48,70,0.2)]">
          ...
          <div className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1/4 text-[40rem] text-[#60CBED] mix-blend-multiply opacity-10 pointer-events-none select-none animate-pulse">
            🐙
          </div>
          ...
          {/* 💡 Đã fix rounded-4xl thành rounded-[2.5rem] */}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div>
                  ...
                  <input type="text" name="name" required placeholder="Nhập tên của bạn..." 
                    className="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:border-[#60CBED] focus:bg-white focus:ring-4 focus:ring-[#60CBED]/10 transition-all text-sm text-[#003046] font-bold" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea name="message" required placeholder="Bạn muốn hỏi về chương trình học, học phí hay lịch học..." rows={5}
                  className="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:border-[#60CBED] focus:bg-white focus:ring-4 focus:ring-[#60CBED]/10 transition-all text-sm text-[#003046] font-bold resize-none leading-relaxed" />
              </div>

              <div className="pt-4">
                <button type="submit" className="w-full bg-[#FDB714] text-[#003046] font-black py-5 rounded-2xl shadow-[0_10px_25px_rgba(253,183,20,0.3)] hover:shadow-[0_15px_35px_rgba(253,183,20,0.5)] hover:-translate-y-1 transition-all uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3">
                  🚀 Gửi tin nhắn ngay!
                </button>
              </div>
            </form>
      ...
      {/* 💡 ĐÃ FIX LỖI: z-[9999] thay vì z-9999 */}
